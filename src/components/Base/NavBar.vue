  ...
  <nav class="navigation">
    <ul class="navigation__list">
      <NavBarItem
        ...
        :pageImg="getImgUrl(pageImgs[i], pageIDs[i])"
        :isActive="getActive(pageIDs[i])"
      />
    </ul>
  </nav>
</template>
...
export default {
  ...
  data() {
    return {
      ...
      pageIDs: ["MainPage", "OrdersPage", "RahmetPage"],
      pageImgs: ["Home", "Order", "Rahmet"],
    };
  },
  methods: {
    getActive(page) {
    ...
    getImgUrl: function (imagePath, page) {
